...
import { DEFAULT_HOSTNAME, DEFAULT_PORT, DEFAULT_SECURE } from '../../common/constants'
...
const AuthForm = props => {
  ...
  const submitHandler = event => {
    ...
    const loginURL = getURL(enteredHostName, enteredPort, enteredIsSecure, '/auth/login')
    ...
    fetch(loginURL, {
      ...
      .then(headers => {
        ...
        const callQueryToken = async () => {
          const queryResponse = await queryTokenExpiry(enteredHostName, enteredPort, enteredIsSecure, token)
          ...
          authCtx.login(enteredHostName, enteredPort, enteredIsSecure, enteredUserID, token, expirationTime.toString())
