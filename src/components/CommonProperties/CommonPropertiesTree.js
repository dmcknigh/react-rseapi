...
import { fetchNamespaces } from "../../util/common-properties-service";
import { fetchContent } from "../../util/common-properties-service";
    ...
    const callFetchProperties = async () => {
      ...
      const transformedResults = jkeys.map((key) => {
        ...
        return {
          ...
          type: "PROPERTY",
          children: isPrimative
            ? null
            : [getPendingChild(pathValue + ".children")],
        };
      });
